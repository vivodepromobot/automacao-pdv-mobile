"""
Test Venda Futura - Testes de venda futura (retirada loja e domicilio).
"""
import pytest
import allure
...
class TestVendaFutura:
    ...
    @allure.title("Venda Futura - Entrega Domicilio")
    @allure.description("""
    Teste de venda futura com entrega em domicilio:
    1. Acessar menu Venda Futura
    2. Selecionar entrega em domicilio
    3. Selecionar vendedor
    4. Buscar cliente por CPF
    5. Adicionar produto com tamanho
    6. Selecionar pagamento a vista
