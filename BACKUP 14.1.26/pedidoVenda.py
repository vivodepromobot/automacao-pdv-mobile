...
def run_test_pedido_venda():
    ...
    try:
        ...
        # Seleção do cliente conforme sua lógica
        ...
        executar_passo("Pedido Gerado", lambda: validar_texto_e_clicar_por_id(driver, "Pedido gerado com sucesso!", "button17"))
        # --- FIM DO FLUXO DE PEDIDO ---

        # Define sucesso ANTES do finally
        teste_passou = True
