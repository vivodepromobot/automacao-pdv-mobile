...
def run_test_vendafuturaDomicilio():
    start_time = datetime.now()
    driver = None
    teste_passou = False
    erro_capturado = None
    NOME_TESTE = "VENDA_FUTURA DOMICILIO"
    ...
    try:
        ...
        executar_passo("Selecione 'Retirada em loja'", lambda: clicar_por_id(driver, "btn_venda_futura_domicilio"))

        executar_passo("Tela do FRETE'", lambda: clicar_por_texto(driver, "Avançar"))
